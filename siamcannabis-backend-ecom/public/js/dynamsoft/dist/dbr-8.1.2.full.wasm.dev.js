...
var ca = "./this.program",
    ...
    fa = !1,
    ha = !1;
da = "object" === (typeof window === "undefined" ? "undefined" : _typeof(window));
...
var h = "",
    ...
    ka,
    la;
if (fa) h = ea ? require("path").dirname(h) + "/" : __dirname + "/", ia = function ia(a, b) {
  ka || (ka = require("fs"));
  la || (la = require("path"));
  a = la.normalize(a);
...
};else if (ha) "undefined" != typeof read && (ia = function ia(a) {
  return read(a);
}), ja = function ja(a) {
  ...
  return a;
}, "undefined" !== typeof print && ("undefined" === typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" !== typeof printErr ? printErr : print);else if (da || ea) ea ? h = self.location.href : document.currentScript && (h = document.currentScript.src), h = 0 !== h.indexOf("blob:") ? h.substr(0, h.lastIndexOf("/") + 1) : "", ia = function ia(a) {
...
"object" !== (typeof WebAssembly === "undefined" ? "undefined" : _typeof(WebAssembly)) && r("No WebAssembly support found. Build with -s WASM=0 to target JavaScript instead.");
var qa,
    ra = new WebAssembly.Table({
  initial: 6617,
  maximum: 6617,
  element: "anyfunc"
}),
...
function kb() {
  ...
  null === hb && "undefined" !== typeof setInterval && (hb = setInterval(function () {
    if (sa) clearInterval(hb), hb = null;else {
      var a = !1,
          b;
...
var Db = {
    ...
    if (!a.input.length) {
      ...
      if (fa) {
        ...
        try {
          ...
          if (-1 != g.toString().indexOf("EOF")) e = 0;else throw g;
        }
  ...
  createNode: function createNode(a, b, d, e) {
  ...
  Ja: function Ja(a, b) {
    if (a.j != b) if (0 == b) a.c = null, a.j = 0;else {
      if (!a.c || a.c.subarray) {
        var d = a.c;
  ...
  f: {
    ...
    rename: function rename(a, b, d) {
      if (L(a.mode)) {
        try {
          var e = Kb(b, d);
        } catch (f) {}

        if (e) for (var g in e.c) {
          throw new J(55);
        }
      }
    ...
    symlink: function symlink(a, b, d) {
  ...
  g: {
    read: function read(a, b, d, e, g) {
      var f = a.node.c;
      if (g >= a.node.j) return 0;
      a = Math.min(a.node.j - g, e);
      assert(0 <= a);
      if (8 < a && f.subarray) b.set(f.subarray(g, g + a), d);else for (e = 0; e < a; e++) {
        b[d + e] = f[g + e];
      }
      return a;
    },
    write: function write(a, b, d, e, g, f) {
      ...
      if (b.subarray && (!a.c || a.c.subarray)) {
        if (f) return assert(0 === g, "canOwn must imply no weird position inside the file"), a.c = b.subarray(d, d + e), a.j = e;
        if (0 === a.j && 0 === g) return a.c = b.slice(d, d + e), a.j = e;
        if (g + e <= a.j) return a.c.set(b.subarray(d, d + e), g), e;
      }

      K.na(a, g + e);
      if (a.c.subarray && b.subarray) a.c.set(b.subarray(d, d + e), g);else for (f = 0; f < e; f++) {
        a.c[g + f] = b[d + f];
      }
    ...
    ka: function ka(a, b, d) {
      K.na(a.node, b + d);
      a.node.j = Math.max(a.node.j, b + d);
    },
    ra: function ra(a, b, d, e, g, f) {
      assert(0 === b);
...
function N(a, b) {
  ...
  for (e = 0; e < a.length; e++) {
    ...
    if (!f || b.fa) for (f = 0; 40960 === (g.mode & 61440);) {
...
function Wb(a) {
  ...
  if (Rb[b] === a) Rb[b] = a.R;else for (b = Rb[b]; b;) {
    if (b.R === a) {
      b.R = a.R;
      break;
    }
...
function dc(a, b) {
  ec || (ec = function ec() {}, ec.prototype = {});
  var d = new ec(),
      e;
...
function kc(a, b, d, e) {
  ...
  if ("object" === _typeof(a)) var f = a;else {
    a = wb(a);
  ...
  if (!g && (d = f ? 40960 === (f.mode & 61440) ? 32 : L(f.mode) && ("r" !== $b(b) || b & 512) ? 31 : Xb(f, $b(b)) : 44)) throw new J(d);
...
function Mc(a) {
  if ("undefined" === typeof FinalizationGroup) return Mc = function Mc(b) {
    return b;
  }, a;
  Jc = new FinalizationGroup(function (b) {
    for (var d = b.next(); !d.done; d = b.next()) {
      d = d.value, d.i ? Lc(d) : console.warn("object already deleted: " + d.i);
    }
  });
...
function Vc(a, b, d) {
  for (; b !== d;) {
    b.W || S("Expected null or instance of " + d.name + ", got an instance of " + b.name), a = b.W(a), b = b.A;
  }
...
function Yc(a, b) {
  ...
  if (this.Z) switch (void 0 === b.b.u && S("Passing raw pointer to smart pointer is illegal"), this.La) {
    case 0:
      b.b.v === this ? d = b.b.u : S("Cannot convert argument of type " + (b.b.v ? b.b.v.name : b.b.l.name) + " to parameter type " + this.name);
      break;
...
function ed(a, b) {
  for (void 0 === b && S("ptr should not be undefined"); a.A;) {
    b = a.W(b), a = a.A;
  }
...
function wd(a, b) {
  ...
  for (var e = b, g = [], f, k;;) {
    ...
    if (37 == f) {
      ...
      var w = 0;
      if (42 == k) w = d("i32"), a++, k = D[a + 1 >> 0];else for (; 48 <= k && 57 >= k;) {
        w = 10 * w + (k - 48), a++, k = D[a + 1 >> 0];
      }
      var l = !1,
          u = -1;
      ...
      switch (String.fromCharCode(k)) {
        ...
        case "p":
          ...
          var C = Math.abs(f);
          m = "";
          if (100 == k || 105 == k) var v = bb(f, 8 * x, 1).toString(10);else if (117 == k) v = ab(f, 8 * x, 1).toString(10), f = Math.abs(f);else if (111 == k) v = (n ? "0" : "") + C.toString(8);else if (120 == k || 88 == k) {
            m = n && 0 != f ? "0x" : "";
            ...
            if (0 > f) {
              ...
              for (n = 0; n < v.length; n++) {
                C.push((15 - parseInt(v[n], 16)).toString(16));
              }

              for (v = C.join(""); v.length < 2 * x;) {
                v = "f" + v;
              }
        ...
        case "G":
          f = d("double");
          if (isNaN(f)) v = "nan", p = !1;else if (isFinite(f)) {
            l = !1;
            x = Math.min(u, 20);
            ...
            if (101 == k || 69 == k) v = f.toExponential(x), /[eE][-+]\d$/.test(v) && (v = v.slice(0, -1) + "0" + v.slice(-1));else if (102 == k || 70 == k) v = f.toFixed(x), 0 === f && (0 > f || 0 === f && -Infinity === 1 / f) && (v = "-" + v);
            m = v.split("e");
            if (l && !n) for (; 1 < m[0].length && -1 != m[0].indexOf(".") && ("0" == m[0].slice(-1) || "." == m[0].slice(-1));) {
              m[0] = m[0].slice(0, -1);
            } else for (n && -1 == v.indexOf(".") && (m[0] += "."); u > x++;) {
              m[0] += "0";
            }
          ...
          for (; v.length < w;) {
            b ? v += " " : !p || "-" != v[0] && "+" != v[0] ? v = (p ? "0" : " ") + v : v = v[0] + "0" + v.slice(1);
          }
...
function yd(a) {
  ...
  for (g in a) {
    ...
    e || (d += ", ");
    e = !1;
    d = "number" === typeof f || "string" === typeof f ? d + f : d + ("(" + _typeof(f) + ")");
  }
...
function zd(a) {
  ...
  var d = null;
  if (a & 128) for (d = yd(arguments); 0 <= d[1].indexOf("_emscripten_");) {
    d = yd(d[0]);
  }
  var e = b.split("\n");
  b = "";
  ...
  for (m in e) {
    ...
    if ((n = k.exec(q)) && 5 == n.length) {
      ...
      var z = n[3];
      n = n[4];
    } else if ((n = g.exec(q)) || (n = f.exec(q)), n && 4 <= n.length) q = n[1], p = n[2], z = n[3], n = n[4] | 0;else {
      b += q + "\n";
      continue;
    }
    ...
    if (a & 8) {
      ...
      if (l = u && u.source) a & 64 && (u.source = u.source.substring(u.source.replace(/\\/g, "/").lastIndexOf("/") + 1)), b += "    at " + w + " (" + u.source + ":" + u.line + ":" + u.wa + ")\n";
    }
...
function Od(a, b, d, e) {
  ...
  for (var p in n) {
    d = d.replace(new RegExp(p, "g"), n[p]);
  }
  ...
  for (p in n) {
    0 <= d.indexOf(p) && (d = d.replace(new RegExp(p, "g"), n[p](e)));
  }
...
for (var Pd = Array(256), Qd = 0; 256 > Qd; ++Qd) {
  Pd[Qd] = String.fromCharCode(Qd);
}
...
var Sd = {
  ...
  __handle_stack_overflow: function __handle_stack_overflow() {
    r("stack overflow");
  },
  ...
  __sys_fcntl64: function __sys_fcntl64(a, b, d) {
    tc = d;
  ...
  __sys_getdents64: function __sys_getdents64(a, b, d) {
    try {
      var e = vc(a);
      ...
      for (var k = mc(e, 0, 1), m = Math.floor(k / 280); m < e.K.length && a + 280 <= d;) {
        ...
        if ("." === q[0]) {
          ...
          var z = Kb(e.node, q);
          n = z.id;
          p = 8192 === (z.mode & 61440) ? 2 : L(z.mode) ? 4 : 40960 === (z.mode & 61440) ? 10 : 8;
        }
  ...
  __sys_ioctl: function __sys_ioctl(a, b, d) {
    tc = d;
  ...
  __sys_mkdir: function __sys_mkdir(a, b) {
    try {
  ...
  __sys_open: function __sys_open(a, b, d) {
    tc = d;
  ...
  __sys_readlink: function __sys_readlink(a, b, d) {
    try {
      a = y(a);
      if (0 >= d) var e = -28;else {
        var g = Tb(a),
            f = Math.min(d, xa(g)),
            k = D[b + f];
        wa(g, b, d + 1);
  ...
  __sys_rmdir: function __sys_rmdir(a) {
    try {
      a = y(a);
      var b = N(a, {
        parent: !0
      ...
      try {
        ...
        t("FS.trackingDelegate['willDeletePath']('" + a + "') threw an exception: " + f.message);
      }
  ...
  __sys_unlink: function __sys_unlink(a) {
    try {
      a = y(a);
      var b = N(a, {
        parent: !0
  ...
  _embind_register_bool: function _embind_register_bool(a, b, d, e, g) {
    var f = wc(d);
    b = R(b);
    U(a, {
      name: b,
      ...
      toWireType: function toWireType(k, m) {
        return m ? e : g;
      },
      argPackAdvance: 8,
      readValueFromPointer: function readValueFromPointer(k) {
        if (1 === d) var m = D;else if (2 === d) m = Ba;else if (4 === d) m = B;else throw new TypeError("Unknown boolean type size: " + b);
        return this.fromWireType(m[k >> f]);
      },
      D: null
    });
  },
  _embind_register_class: function _embind_register_class(a, b, d, e, g, f, k, m, q, n, p, z, w) {
    p = R(p);
    f = W(g, f);
    m && (m = W(k, m));
    n && (n = W(q, n));
    ...
    T([a, b, d], e ? [e] : [], function (u) {
      ...
      u = Cc(l, function () {
        ...
        if (void 0 === F.J) throw new Ec(p + " has no accessible constructor");
  ...
  _embind_register_class_class_function: function _embind_register_class_class_function(a, b, d, e, g, f, k) {
    var m = od(d, e);
    b = R(b);
    f = W(g, f);
    T([], [a], function (q) {
  ...
  _embind_register_class_constructor: function _embind_register_class_constructor(a, b, d, e, g, f) {
    assert(0 < b);
    var k = od(b, d);
    g = W(e, g);
    var m = [f],
    ...
    T([], [a], function (n) {
      ...
      T([], k, function (z) {
        n.h.J[b - 1] = function () {
          arguments.length !== b - 1 && S(p + " called with " + arguments.length + " arguments, expected " + (b - 1));
          q.length = 0;
          m.length = b;

          for (var w = 1; w < b; ++w) {
            m[w] = z[w].toWireType(q, arguments[w - 1]);
          }
  ...
  _embind_register_class_function: function _embind_register_class_function(a, b, d, e, g, f, k, m) {
    var q = od(d, e);
    b = R(b);
    f = W(g, f);
    T([], [a], function (n) {
      ...
      var w = n.h.H,
          l = w[b];
      void 0 === l || void 0 === l.o && l.className !== n.name && l.N === d - 2 ? (p.N = d - 2, p.className = n.name, w[b] = p) : (Sc(w, b, z), w[b].o[d - 2] = p);
      T([], q, function (u) {
        u = nd(z, u, n, f, k);
  ...
  _embind_register_class_property: function _embind_register_class_property(a, b, d, e, g, f, k, m, q, n) {
    b = R(b);
    g = W(e, g);
    T([], [a], function (p) {
      p = p[0];
  ...
  _embind_register_float: function _embind_register_float(a, b, d) {
    d = wc(d);
    b = R(b);
    U(a, {
      name: b,
      ...
      toWireType: function toWireType(e, g) {
  ...
  _embind_register_integer: function _embind_register_integer(a, b, d, e, g) {
    function f(n) {
      return n;
    }
    ...
    U(a, {
      name: b,
      fromWireType: f,
      toWireType: function toWireType(n, p) {
  ...
  _embind_register_memory_view: function _embind_register_memory_view(a, b, d) {
    function e(f) {
      f >>= 2;
      var k = E;
  ...
  _embind_register_std_string: function _embind_register_std_string(a, b) {
    ...
    U(a, {
      ...
      fromWireType: function fromWireType(e) {
        var g = E[e >> 2];
        if (d) for (var f = e + 4, k = 0; k <= g; ++k) {
          var m = e + 4 + k;

          if (0 == A[m] || k == g) {
            f = y(f, m - f);
            if (void 0 === q) var q = f;else q += String.fromCharCode(0), q += f;
            f = m + 1;
          }
        } else {
          q = Array(g);
          ...
          for (k = 0; k < g; ++k) {
            q[k] = String.fromCharCode(A[e + 4 + k]);
          }
      ...
      toWireType: function toWireType(e, g) {
        ...
        var k = (d && f ? function () {
          ...
          return g.length;
            ...
            m = Ia(4 + k + 1);
        E[m >> 2] = k;
        if (d && f) wa(g, m + 4, k + 1);else if (f) for (f = 0; f < k; ++f) {
  ...
  _embind_register_std_wstring: function _embind_register_std_wstring(a, b, d) {
    d = R(d);
    ...
    if (2 === b) {
      ...
      var m = 1;
    } else 4 === b && (e = Ea, g = Fa, f = Ga, k = function k() {
      return E;
    }, m = 2);

    U(a, {
      name: d,
      fromWireType: function fromWireType(q) {
        for (var n = E[q >> 2], p = k(), z, w = q + 4, l = 0; l <= n; ++l) {
          var u = q + 4 + l * b;
          if (0 == p[u >> m] || l == n) w = e(w, u - w), void 0 === z ? z = w : (z += String.fromCharCode(0), z += w), w = u + b;
        }

        X(q);
        return z;
      },
      toWireType: function toWireType(q, n) {
  ...
  _emval_take_value: function _emval_take_value(a, b) {
    var d = zc[a];
    void 0 === d && S("_emval_take_value has unknown type " + id(a));
  ...
  emscripten_log: function emscripten_log(a, b, d) {
    var e = "";
    b = wd(b, d);
    ...
    a & 1 ? a & 4 ? console.error(e) : a & 2 ? console.warn(e) : a & 512 ? console.info(e) : a & 256 ? console.debug(e) : console.log(e) : a & 6 ? t(e) : ma(e);
  },
  emscripten_memcpy_big: function emscripten_memcpy_big(a, b, d) {
  ...
  emscripten_run_script: function emscripten_run_script(a) {
    eval(y(a));
  },
  emscripten_run_script_int: function emscripten_run_script_int(a) {
    return eval(y(a)) | 0;
  },
  emscripten_run_script_string: Z,
  environ_get: function environ_get(a, b) {
    var d = 0;
    Bd().forEach(function (e, g) {
      var f = b + d;
      g = B[a + 4 * g >> 2] = f;
  ...
  fd_read: function fd_read(a, b, d, e) {
    try {
      a: {
        for (var g = vc(a), f = a = 0; f < d; f++) {
          ...
          if (!w) p = m.position;else if (!m.seekable) throw new J(70);
      ...
      return "undefined" !== typeof Q && C instanceof J || r(C), C.m;
    }
  },
  fd_seek: function fd_seek(a, b, d, e, g) {
    try {
      var f = vc(a);
      a = 4294967296 * d + (b >>> 0);
  ...
  fd_write: function fd_write(a, b, d, e) {
    try {
      a: {
        for (var g = vc(a), f = a = 0; f < d; f++) {
          var k = g,
          ...
          if (!z) n = k.position;else if (!k.seekable) throw new J(70);
          ...
          try {
            ...
            t("FS.trackingDelegate['onWriteToFile']('" + k.path + "') threw an exception: " + x.message);
          }
  ...
  localtime: function localtime(a) {
    Ed();
    a = new Date(1E3 * B[a >> 2]);
  ...
  pthread_mutexattr_destroy: function pthread_mutexattr_destroy() {},
  pthread_mutexattr_init: function pthread_mutexattr_init() {},
  pthread_mutexattr_settype: function pthread_mutexattr_settype() {},
  pthread_spin_destroy: function pthread_spin_destroy() {
    return 0;
  },
  pthread_spin_init: function pthread_spin_init() {
    return 0;
  },
  pthread_spin_lock: function pthread_spin_lock() {
    return 0;
  },
  pthread_spin_unlock: function pthread_spin_unlock() {
    return 0;
  },
  setTempRet0: function setTempRet0() {},
  strftime: Od,
  strftime_l: function strftime_l(a, b, d, e) {
    return Od(a, b, d, e);
  },
  table: ra,
...
(function () {
  ...
  function d(f) {
    return sb().then(function (k) {
      ...
      t("failed to asynchronously prepare wasm: " + k);
      r(k);
    });
  }
  ...
  function a() {
    if (!Td && (Td = !0, c.calledRun = !0, !sa)) {
      ...
      if (!c.noFSInit && !oc) {
        ...
        c.stderr ? qc("stderr", null, c.stderr) : jc("/dev/tty1", "/dev/stderr");
      ...
      if (c.postRun) for ("function" == typeof c.postRun && (c.postRun = [c.postRun]); c.postRun.length;) {
        b = c.postRun.shift(), Ya.unshift(b);
      }
      Ta(Ya);
    }
  }
