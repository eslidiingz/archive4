                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col">น้ำหนัก (กรัม)</th>
                                        <th scope="col">กทม.-กทม. (บาท)</th>
                                        <th scope="col">กทม.-ตจว. (บาท)</th>
                                        <th scope="col">ตจว.-ตจว. (บาท)</th>
                                    </tr>
                                </thead>
                                <tbody id="fetchData">
                                    @foreach ($shipping_detail[$item->shipty_id] as $val)
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th>น้ำหนัก (กรัม)</th>
                                            <th>ราคา (พื้นที่เดียวกัน)</th>
                                            <th>ราคา (ต่างพื้นที่)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
