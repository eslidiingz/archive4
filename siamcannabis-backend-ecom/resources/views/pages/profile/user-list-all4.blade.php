<div class="col-12 px-0">
    <table class="table-bordered">
        ...
        <tbody>
            @foreach ($shop_id->where('status',5) as $key_shop => $item)
            <tr>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <button class='o-btn mb-2' data-toggle="modal"
                                            data-target-id="{{ $invs[$key_shop]->id }}"
                                            data-target-shop_id="{{$invs[$key_shop]->shop_id}}"
                                            data-target-user_id="{{$invs[$key_shop]->user_id}}"
                                            data-target-product_id="{{$product_id}}"
                                            data-target-date="{{date('Y-m-d H:i:s')}}" data-target-status="1"
                                            data-target="#ratingmodal">ให้คะแนนร้านค้า</button>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="row align-items-center">
