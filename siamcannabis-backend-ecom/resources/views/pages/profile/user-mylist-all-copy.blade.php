<div>
    <div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-4 col-6">
                        <a href='#' style='color:#1947e3'>
                            ...
                            @if($invs[$key_shop]->status == 0)
                            ที่ต้องชำระ
                            @endif
                            @if($invs[$key_shop]->status == 1)
                            ที่ต้องชำระ
                            @endif
                            @if($invs[$key_shop]->status == 2)
                            ที่ต้องจัดส่ง
                            @endif
                            @if($invs[$key_shop]->status == 3)
                            จัดส่งแล้ว
                            @endif
                            @if($invs[$key_shop]->status == 4)
                            ส่งสำเร็จแล้ว
                            @endif
                            @if($invs[$key_shop]->status == 5)
                            สำเร็จ
                            @endif
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="row">
                    <div class="col-12 mb-4 text-left">
                        <div class="media">
                            @foreach ($product as $key_pro => $pro)
                            @if($pro->id == $pay['product_id'])
                            <img src="{{ asset('img/products/'.$pro->product_img[0]) }}" style="width: 60px;"
        ...
        <div class="row py-4 mx-0" style="background-color: #fff;">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="col-lg-6 col-md-6 col-12">
                    <a href="/profile/cancel/{{$invs[$key_shop]->id}}"
                        onclick="if(! confirm('คุณต้องการยกเลิกคำสั่งซื้อ ใช่หรือไม่?')) {return false;}">
                        <button class='o-btn mb-2'>ยกเลิกคำสั่งซื้อ</button>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-12">
                        <button class='o-btn-purple mb-2'>ชำระเงิน</button>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12 text-lg-right text-md-right text-left mt-lg-0 ">
        ...
        <div class="row py-4 mx-0" style="background-color: #fff;">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <button type="button" class="o-btn mb-2" data-toggle="modal" data-target="#cancelmodal1"
                        data-target-id_cancel="{{ $invs[$key_shop]->id }}">
                        ยกเลิกคำสั่งซื้อ
                    </button>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-12">
                        <button class='o-btn-purple mb-2' style="opacity: 0.5" disabled>รับสินค้า</button>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12 text-lg-right text-md-right text-left mt-lg-0 ">
                        <button class='o-btn mb-2'>รายละเอียดคำสั่งซื้อ</button>
                    </div>
        ...
        <div class="row py-4 mx-0" style="background-color: #fff;">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="col-lg-6 col-md-6 col-12">
                    <button type="button" class="o-btn mb-2" style="opacity: 0.5" disabled>
                        ยกเลิกคำสั่งซื้อ
                    </button>
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-12">
                        <button class='o-btn-purple mb-2'>รับสินค้า</button>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12 text-lg-right text-md-right text-left mt-lg-0 ">
                        <button class='o-btn mb-2'>รายละเอียดคำสั่งซื้อ</button>
                    </div>
        ...
        <div class="row py-4 mx-0" style="background-color: #fff;">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="col-lg-6 col-md-6 col-12">
                    <button class='o-btn mb-2' data-toggle="modal" data-target-id_rating="{{ $invs[$key_shop]->id }}"
                        ...
                        data-target-date_rating="{{date('Y-m-d H:i:s')}}" data-target-status_rating="1"
                        data-target="#ratingmodal1">ให้คะแนนร้านค้า</button>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <div class="row align-items-center">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ url('rating') }}">
                            ...
                            <div class="form-group" hidden>
                                <input type="text" class="form-control" name="invs_id" id="inv_id_rating">
                                <input type="text" class="form-control" name="shop_id" id="shop_id_rating">
                                <input type="text" class="form-control" name="user_id" id="user_id_rating">
                                <input type="text" class="form-control" name="product_id" id="product_id_rating">
                                <input type="text" class="form-control" name="date" id="date_rating">
                                <input type="text" class="form-control" name="status" id="status_rating">
                            </div>
                            <div class="form-group" hidden>
                            </div>
                            <div class="rol-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="note" name="comment" cols="30"
                                        rows="10"></textarea>
                                </div>
        ...
        <div class="modal fade" id="cancelmodal1" tabindex="-1" role="dialog" aria-labelledby="cancel_modalLabel"
            ...
            <div class="modal-dialog" role="document" style="width:350px">
                <div class="modal-content shadow-sm rounded border-0">
                    ...
                    <div class="modal-body">
                        <form method="get" id="inv_send_cancel" action="">

                            @csrf
                            <div class="form-group" hidden>
                                <input type="text" class="form-control" name="inv_id_cancel" id="inv_id_cancel">
                            </div>
                            <div class="rol-12">
                                <div class="form-group">
...
<script>
    $(document).ready(function () {
        $("#cancelmodal1").on("show.bs.modal", function (e) {
            var id_cancel = $(e.relatedTarget).data('target-id_cancel');
            $('#inv_id_cancel').val(id_cancel);
            $('#inv_send_cancel').attr('action', '/profile/cancel/content/'+id_cancel);
        });
        ...
        $("#ratingmodal1").on("show.bs.modal", function (e) {
            ...
            $('#inv_id_rating').val(id);
            $('#shop_id_rating').val(shop_id);
            $('#user_id_rating').val(user_id);
            $('#product_id_rating').val(product_id);
            $('#date_rating').val(date);
            $('#status_rating').val(status);
        });
    });
</script>
