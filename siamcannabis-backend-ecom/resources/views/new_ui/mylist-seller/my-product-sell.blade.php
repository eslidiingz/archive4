<div class="col-12 px-0">
	<table class="table-bordered">
		...
		<tbody>
			@foreach($products->where('status_goods',0) as $key=>$product)
						...
						<div class="col-12 mb-4 text-left">
							<div class="media">
								<a href="/product/{{$product->id}}">
									<img src="{{'/img/product/'.$product->product_img[0] }}" style="width: 60px;" class="mr-3 rounded8px" onerror="this.onerror=null;this.src='/img/no_image.png'" alt="...">
								</a>
