...
<div class="container">
    <div class="col-12 px-0 d-flex flex-row">
        ...
        <div class="col-xl-9 col-lg-12 col-md-12 col-12  my-4">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 pt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-12 strong-text" style="margin-bottom: 20px;">
                                            <input required style='background-color:#f0f0f0' type="password" class="form-control" id="current-password" name='current-password' aria-describedby="emailHelp" placeholder="รหัสผ่านใหม่">
                                        </div>
                                        <div class="col-lg-6">
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-12 title_posit" style='padding-top: 5px;'>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-12 strong-text" style="margin-bottom: 20px;">
                                            <input required style='background-color:#f0f0f0' type="password" class="form-control" id="new-password" name='new-password' aria-describedby="emailHelp" placeholder="รหัสผ่านเก่า">
                                        </div>
                                        <div class="col-lg-6">
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-12 title_posit" style='padding-top: 5px;'>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-12 strong-text" style="margin-bottom: 20px;">
                                            <input required style='background-color:#f0f0f0' type="password" class="form-control" id="re-new-password" name='re-new-password' aria-describedby="emailHelp" placeholder="ยืนยันรหัสผ่านใหม่">
                                        </div>
                                        <div class="col-lg-6">
                                        </div>
