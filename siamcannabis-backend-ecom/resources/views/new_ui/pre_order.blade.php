    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-2">
                <h3 class="mb-0"><img src="img/pre_order.svg" class="pr-2" style="width: 35px;" alt=""><strong>Pre-Order</strong></h3>
            </div>
            <div class="col-12">
        ...
        <div class="col-12">
            <div class="row mt-lg-0 mt-md-4 mt-4">
                ...
                <div class="col-lg-2 col-md-4 col-6">
                    <a href="{{ url('product-detail-preorder') }}">
                        <div class="rounded8px px-2 "
                            ...
                            <div class="d-flex align-items-center justify-content-center h-200px pt-2 position-relative"
                                ...
                                <img src="img/product/16.jpg" class="rounded8px "
                                    style="max-height: 95%;width: 100%; height: 100%; object-fit: cover;"
                                    alt="...">
                                <div class="position-absolute pl-2 pr-4 py-1" style="clip-path: polygon(100% 0%, 90% 50%, 100% 100%, 0 100%, 0% 50%, 0 0); bottom: 15px; left: 0; background-color: #23c197;">
                                    <h6 class="mb-0" style="font-size: 14px;"><strong style="color: #fff;">Pre - Order</strong></h6>
                                </div>
      
                            </div>
                            <h6 class="card-title mb-0 text-left text-dots pt-2 font_head_item">
                                <strong>Basicsbysita | A224….</strong>
                            </h6>
                            <div class="col-12 px-0 d-flex justify-content-start py-1">
                                <button class="btn py-0 px-1" style="border: 1px solid #23c197; font-size: 10px; color: #23c197;"><strong>พรีออเดอร์ : 1 -12 พฤศจิ 2020</strong></button>
                            </div>
                            <h2 class="card-text mb-0 text-left font_price" style="color: #c75ba1;">
                                <strong>฿
                                    790</strong>
                            </h2>
                            <h6 class="text-left mb-3 pb-1 d-flex align-items-start"
