                                    ...
                                    <div class='col-12 py-3'>
                                        <div class='row'>
                                            <div class='col-lg-2 col-md-2'>
                                                <img src='new_ui/img/user_icon_menu/user-seller.png' style='width:100px'>
                                            </div>
                                            <div class='col-lg-8 col-md-8'>
                                                <a href='#' style='color:black'><strong>การชำระเงินเสร็จแล้ว</strong></a>
                                                <p>หมายเลขคำสั่งซื้อ. 20021496M4SGS2 เราได้แจ้งผู้ส่งสินค้าเรียบร้อยแล้ว กรุณารอรับสินค้า
                                                    ภายใน 5-7 วันทำการค่ะ</p>
                                                <a style='color:#c75ba1'><strong>23/05/20 15:30</strong></a>
                                            </div>
                                            <div class='col-lg-2 col-md-2'>
                                                <button class='o-btn-purple '>รีวิวสินค้า</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class='col-12 py-3'>
