                                ...
                                <div class="col-12 text-lg-left text-md-right text-sm-right">
                                    <div class="form-check">
                                        ...
                                        @if($withdrawdata->status == 0)
                                            ...
                                            @else
                                                <a href="{{route('addsellerbank')}}" style="color:red;" >*เพิ่มบัญชีธนาคารเพื่อถอน</a>
                                            @endif
                                        @else
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            {{-- <div class="col-12 mt-3">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <h6><strong>ราคาสินค้า</strong></h6>
                                                    </div>
                                            ...
                                            <div class="col-12 mt-0">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <h6><strong>ราคาสินค้าหลังหักค่า GP</strong></h6>
                                                    </div>
                                                    <div class="col-6 px-0 text-right">
                                                        @if ((isset($withdrawdata->uidmp) || $withdrawdata->uidmp != null || $withdrawdata->uidmp != '') && (isset($item->margin) || $item->margin != null || $item->margin != ''))
