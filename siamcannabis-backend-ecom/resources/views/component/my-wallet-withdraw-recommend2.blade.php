...
<div class="col-12 px-0">
    <table class="table-bordered " id='withdraw_tb'>
        ...
        <tbody class="hd_row">
            @foreach ($withdraw->whereIn('status', [1,2]) as $item)
                <tr>
                    ...
                    <td data-label="จำนวนเงิน" class="font_size_14px">
                        <div class="row">
                            <div class="col-12 mb-2 text-lg-left text-md-right text-sm-right pr-0">
                                <h6 class="mb-0 font_size_14px" style="cursor: pointer; "><strong>{{ number_format($item->amount,0) }}</strong></h6>
                            </div>
                        </div>
                    </td>
                    <td data-label="สถานะ" class="font_size_14px">
                        <div class="row">
                            <div class="col-12 mb-2 text-lg-left text-md-right text-sm-right pr-0">
                                <h6 class="mb-0 font_size_14px" style="cursor: pointer; "><strong>
                                    @if ($item->status == 1)
                                        รอดำเนินการ
