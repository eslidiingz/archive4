    ...
    <div class="col-xl-9 col-lg-12 col-md-12 col-12 px-4 px-lg-4 px-md-4 px-2 mb-4">
        <div class="row">
            <div class="col-lg-12 col-md-6 col-12 px-4 pt-4 pb-0">
                ...
                @else
                    <h6 class="text-danger mb-0">* คุณจะไม่สามารถถอนเงินได้ หากยังไม่ได้กรอกข้อมูลธนาคาร</h6>
                @endif
            </div>
        </div>
        <div class="row px-lg-6 px-md-6 px-0 py-lg-4 py-md-4 py-4 mx-0 rounded8px" style="background-color: #346751;">
            <div class="col-lg-6 col-md-6 col-12">
                <h5 class="font_head_item" style="color:#fff;"><img src="/new_ui/img/seller/icon_menu/icon_menu_3new.svg" style="width: 25px;" class="mr-2" alt=""><strong>ยอดเงินที่ต้องการถอน</strong></h5>
            ...
            <div class="col-lg-6 col-md-6 col-12 d-flex align-items-center justify-content-end flex-column">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h6 class="text-right text-dangers mb-0">*&nbsp;1.&nbsp;บริษัทได้รับแจ้งความประสงค์ก่อน 12.00 น. ลูกค้าจะได้รับเงินภายในวันทำการนั้น</h6>
                        <h6 class="text-right text-dangers">*&nbsp;2.&nbsp;บริษัทได้รับแจ้งความประสงค์หลัง 12.00 น. ลูกค้าจะได้รับเงินในวันทำการวันถัดไป</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            {{-- <div class="col-4 px-0">
                <form>
                  <div class="form-group">
                    <label for="statusMoney"><strong>เลือกสถานะ</strong></label>
                    <select class="form-control" id="statusMoney">
                      <option>ทั้งหมด</option>
                      <option>ถอนแล้ว</option>
                      <option>3</option>
                      <option>4</option>
                      <option>5</option>
                    </select>
                ...
                <div class="d-lg-block d-md-block d-none">
                    <ul class="nav nav-tabss" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link nav-links active" id="list-1-tab" data-toggle="tab" href="#list-1" role="tab" aria-controls="list-1" aria-selected="true">ถอนเงิน</a>
                        </li>
                    </ul>
                </div>
            ...
            <form action="/shop/search_seller" method="GET">
                <div class="col-12">
                    ...
                    <div class="col-12 ">
                        ...
                        <button type="submit" class=" mx-0 form-control d-flex justify-content-center align-items-center btns" style=""><i class="fa fa-search pr-2" aria-hidden="true"></i>ค้นหา</button>
                    </div>
                </div>
            </form>
        </div>
