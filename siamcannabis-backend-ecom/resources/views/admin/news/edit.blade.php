        ...
        <div class="row py-4">
            <div class="col-12">
                <div class="card p-4">
                    ...
                    <form class="row" role="form" action="{{ url('dashboard/news/edit') }}" method="post"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $news->id }}">
                        <input type="hidden" name="admin_id" value="{{ Auth::guard('admin')->user()->id }}">
                        <input type="hidden" name="status" value="{{ $news->status }}">
                        <input type="hidden" name="news_category_id" value="{{ $news->news_category_id }}">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea type="text" rows="4" class="form-control" name="detail" id="detail"
                                placeholder="รายละเอียด" required>{{ $news->detail }}</textarea>
                        </div>
                        <div class="col-12 mb-3">
                            <select class="form-control" name="news_category_id" id="news_category_id" required>
                                <option selected value="{{ $news->news_category_id }}" disabled="">
                                    {{ $news->newsCategory->name }}</option>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <img style="width: 100%; min-height:300px auto;" id="blah1" src="{{ asset($news->img_cover) }}"
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <img style="width: 100%; min-height:300px auto;" id="blah" src="{{ asset($news->images) }}"
                                    onerror="this.onerror=null;this.src='/img/no_banner_medix.png'" alt="your image" />
                                <div class="input-group mt-3">
                                    <div class="custom-file">
                                        <input type="file" class="form-control" style="padding: 3px;"
                        ...
                        <div class="col-12 text-center">
                            ...
                            <button type="button" class="btn btn-outline-pink" data-toggle="modal"
                                data-target="#editModal{{ $news->id }}">
                                บันทึก
                            </button>
                        </div>

                        <div class="modal fade" id="editModal{{ $news->id }}" tabindex="-1" role="dialog"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            คุณต้องการจะแก้ไขข่าวสารนี้ใช่หรือไม่?
                                        </div>
                                    </div>
