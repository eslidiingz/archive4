            ...
            <div class="col-12">
                <div class="card p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3 flex-column flex-lg-row flex-md-row">
                        <div class="">
                            <h5 class="mb-0"><b>ระบบจัดการหน้าที่ของอาหารเสริมทางการแพทย์</b></h5>
                        </div>
                        <form class="flex-fill d-flex flex-column flex-md-row justify-content-end">
                            ...
                            @if (Auth::guard('admin')->user()->type == 'superadmin')
                                <a class="btn btn-outline-pink ml-lg-3 ml-md-2 mt-0 mt-lg-0 text-light"
                                    href="{{ url('dashboard/drug-target/create') }}">เพิ่มหน้าที่ของอาหารเสริมทางการแพทย์</a>
                            @endif
                        </form>
                    </div>
                        ...
                        <table class="table table-borderless table-striped table-sm-responsive">
                            <thead class="thead-blued">
                                <tr>
                                    <th>Action</th>
                                    <th>#</th>
                                    <th>ชื่อหน้าที่ของอาหารเสริมทางการแพทย์</th>
                                    <th>อัปเดตเมื่อ</th>
                                </tr>
                            </thead>
                            <tbody>

                                @foreach ($drugTarget as $key => $value)
                                    <tr>
                                        <td data-label="Action">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a href="{{ url('dashboard/drug-target/edit', $value->id) }}"
                                                ...
                                                <form style="display: inline" role="form"
                                                    action="{{ url('dashboard/drug-target/destroy') }}" method="post">
                                                    {{ csrf_field() }}
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLongTitle">
                                                                        ลบหน้าที่ของอาหารเสริมทางการแพทย์ #{{ $value->name }}</h5>
                                                                ...
                                                                <div class="modal-body text-left">
                                                                    <div class="mb-3">
                                                                        คุณต้องการจะลบหน้าที่ของอาหารเสริมทางการแพทย์นี้ใช่หรือไม่?
                                                                    </div>
                                                                </div>
                                        ...
                                        <td data-label="#">
                                            {{ $drugTarget->perPage() * ($drugTarget->currentPage() - 1) + $key + 1 }}
                                        </td>
                                        <td data-label="ชื่อหน้าที่ของอาหารเสริมทางการแพทย์">{{ $value->name }}</td>
