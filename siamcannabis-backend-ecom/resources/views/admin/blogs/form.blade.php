                ...
                @if ((isset($status) && $status=='true') || !isset($status))
                    <form class="row" id="formAdmin">
                        ...
                        <div class="form-group col-12 col-md-6">
                            <label for="username">ชื่อข่าวสาร</label>
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <select class="form-control" name="type" id="type">
                                <option selected value="" disabled="">กรุณาเลือกหมวดหมู่</option>
                                <option @if(@$user->type == 'admin') selected @endif value="admin">หมวดหมู่ 1</option>
                                <option @if(@$user->type == 'superadmin') selected @endif value="superadmin">หมวดหมู่ 2</option>
                            </select>
                        </div>
                        <div class="form-group col-12 col-md-12">
                            <label for="username">รายละเอียด</label>
                            <textarea type="text" class="form-control" id="username"
                                @if (isset($status))
                                    readonly=""
                                @endif
                                value="{{ @$user->username }}"
                        ...
                        <div class="col-12 text-center">
                            <a href="/dashboard/blogs" class="btn btn-secondary">ย้อนกลับ</a>
