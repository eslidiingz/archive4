        ...
        <div class="row py-4">
            <div class="col-12">
                <div class="card p-4">
                    ...
                    <form class="row" role="form" action="{{ url('dashboard/news-categories/create') }}" method="post"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="col-12 mb-3">
                            <label for="name">ชื่อหมวดหมู่</label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="ชื่อหมวดหมู่" required>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            คุณต้องการจะเพิ่มหมวดหมู่นี้ใช่หรือไม่?
                                        </div>
                                    </div>
