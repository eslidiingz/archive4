            ...
            <div className="row pb-5 pt-3">
              ...
              <div className="col-lg-5 mt-4 mb-6">
                ...
                <div className="layout-profile_ex">
                  ...
                  <p className="text09-2 mt-4 mb-4">
                    ...
                    />
                    &nbsp;<span className="text-detail02_ex">522</span>
                    <span className="text-detail_ex">&nbsp;( 233$ )</span>
                  </p>

                  <div className="row">
                    <div className="col-12 col-sm-6 mb-2 mb-sm-0 mb-2">
                      <button className="btn2 w-full h-36" onClick={showModal}>
                        Make Offer
                      </button>
                    </div>
              ...
              <div className="col-xl-3">
                <div className="layout_main-acc">
                  <p className="text-tittle-des">
                    <i class="fas fa-list-alt mx-2"></i>Deatil
                  </p>
                </div>
                <div className="layout-des_table-detailpage pb-lg-3">
                  <tbody>
                    <tr>
                      <td style={{ width: "100%" }}>
                        <p className="text-detail-acc">Cpntract Address</p>
                      </td>
                      <td>
                            ...
                            <Link href={""}>
                              <div className=" d-flex gap-2 align-items-start ">
                                <p className="mb-0 ci-purple textprofile-des_link">
                                  3 day ago <i class="fas fa-external-link"></i>
                                </p>
                              </div>
                            </Link>
                          </td>
