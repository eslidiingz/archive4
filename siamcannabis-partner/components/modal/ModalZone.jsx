                    ...
                    <Modal.Body>
                        <div className="row project_modal">
                            <div className="col-12 mb-3">
                                <label for="NameProject" className="topic-modal_project">Zone</label>
                                <input type="text" className="form-control" name="NameProject" value="Z1,Z2" disabled />
                                <label for="NameProject" className="topic-modal_project">Name Project</label>
                                <input type="text" className="form-control" name="NameProject" value="Pre-Sell Project"  />
                            ...
                            <div className="col-lg-6">
                                ...
                                <input type="date" className="form-control" name="PalntingTime" />
                            </div>
                            <div className="col-lg-6">
